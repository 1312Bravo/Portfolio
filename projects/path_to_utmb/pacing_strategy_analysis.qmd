...
This means that each sector can have its own baseline in each race year, while the relationship between UTMB Index and sector share is also allowed to differ by sector.

...
| Feature | Coefficient | 95% CI | p-value | Interpretation |
|---|---:|---:|---:|---|
| Early aggressiveness | -0.338 | [-0.373, -0.302] | < 0.001 | More aggressive early pacing is associated with worse normalized race performance. |
| Pacing variability | -0.296 | [-0.352, -0.239] | < 0.001 | More uneven pacing is associated with worse normalized race performance. |
| Late strength | 0.152 | [0.120, 0.183] | < 0.001 | Stronger late-race pacing is associated with better normalized race performance. |
